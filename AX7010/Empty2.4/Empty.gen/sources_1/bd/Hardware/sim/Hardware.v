...
(* CORE_GENERATION_INFO = "Hardware,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=Hardware,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=1,da_axi4_s2mm_cnt=1,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "Hardware.hwdef" *) 
module Hardware
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    ...
    FIXED_IO_ps_porb,
    FIXED_IO_ps_srstb,
    GPIO0_IN_32_GP1_tri_i,
    GPIO0_IN_32_GP2_tri_i,
    GPIO1_OUT_32_GP1_tri_o,
    GPIO1_OUT_32_GP2_tri_o,
    PS_CLK_50,
    S_AXIS_aclk,
    S_AXIS_tdata,
    S_AXIS_tlast,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 GPIO0_IN_32_GP1 TRI_I" *) input [31:0]GPIO0_IN_32_GP1_tri_i;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 GPIO0_IN_32_GP2 TRI_I" *) input [31:0]GPIO0_IN_32_GP2_tri_i;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 GPIO1_OUT_32_GP1 TRI_O" *) output [31:0]GPIO1_OUT_32_GP1_tri_o;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 GPIO1_OUT_32_GP2 TRI_O" *) output [31:0]GPIO1_OUT_32_GP2_tri_o;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.PS_CLK_50 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.PS_CLK_50, CLK_DOMAIN Hardware_processing_system7_0_0_FCLK_CLK0, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) output PS_CLK_50;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.S_AXIS_ACLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.S_AXIS_ACLK, ASSOCIATED_BUSIF S_AXIS, CLK_DOMAIN Hardware_S_AXIS_aclk, FREQ_HZ 125000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input S_AXIS_aclk;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 S_AXIS TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME S_AXIS, CLK_DOMAIN Hardware_S_AXIS_aclk, FREQ_HZ 125000000, HAS_TKEEP 0, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.0, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) input [31:0]S_AXIS_tdata;
  ...
  wire [31:0]axi_gpio_1_GPIO2_TRI_O;
  ...
  assign GPIO1_OUT_32_GP1_tri_o[31:0] = axi_gpio_1_GPIO_TRI_O;
  assign GPIO1_OUT_32_GP2_tri_o[31:0] = axi_gpio_1_GPIO2_TRI_O;
  assign PS_CLK_50 = processing_system7_0_FCLK_CLK0;
  assign S_AXIS_1_1_TDATA = S_AXIS_tdata[31:0];
  assign S_AXIS_1_1_TLAST = S_AXIS_tlast;
  assign S_AXIS_1_1_TVALID = S_AXIS_tvalid;
  assign S_AXIS_tready = S_AXIS_1_1_TREADY;
  assign axi_gpio_0_GPIO2_TRI_I = GPIO0_IN_32_GP2_tri_i[31:0];
  assign axi_gpio_0_GPIO_TRI_I = GPIO0_IN_32_GP1_tri_i[31:0];
  assign s_axis_aclk_0_1 = S_AXIS_aclk;
  Hardware_axi_dma_0_1 axi_dma_0
  ...
  Hardware_axi_gpio_0_0 axi_gpio_0
  ...
  Hardware_axi_gpio_1_0 axi_gpio_1
  ...
  Hardware_axis_data_fifo_0_2 axis_data_fifo_0
  ...
  Hardware_proc_sys_reset_0_1 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  Hardware_processing_system7_0_0 processing_system7_0
  ...
  Hardware_smartconnect_0_0 smartconnect_0
