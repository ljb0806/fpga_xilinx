...
--               e:/Data/Project/VIVADO_Project/2022_2/AX7010/Empty2.1/Empty.gen/sources_1/ip/clk_wiz_1/clk_wiz_1_sim_netlist.vhdl
-- Design      : clk_wiz_1
...
architecture STRUCTURE of clk_wiz_1_clk_wiz is
  ...
  signal i_clk_50_clk_wiz_1 : STD_LOGIC;
  signal o_clk_20_48_clk_wiz_1 : STD_LOGIC;
...
clkin1_ibufg: unisim.vcomponents.IBUF
    generic map(
      ...
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => i_clk_50,
      O => i_clk_50_clk_wiz_1
    );
clkout1_buf: unisim.vcomponents.BUFG
     port map (
      I => o_clk_20_48_clk_wiz_1,
      O => o_clk_20_48
    );
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    generic map(
      BANDWIDTH => "HIGH",
      CLKFBOUT_MULT_F => 28.250000,
      CLKFBOUT_PHASE => 0.000000,
      CLKFBOUT_USE_FINE_PS => false,
      CLKIN1_PERIOD => 20.000000,
      CLKIN2_PERIOD => 0.000000,
      CLKOUT0_DIVIDE_F => 69.000000,
      ...
      CLKIN1 => i_clk_50_clk_wiz_1,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcm_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => o_clk_20_48_clk_wiz_1,
