...
(
    ...
    .probe0(r_AD_DATA_A),
    .probe1(r_AD_DATA_B),
    .probe2(i_AD_DATA_A),     // i_gate_enable
    .probe3(i_AD_DATA_B),           // packer output
    .probe4(S_AXIS_tdata),           // fifo backpressure
    .probe5(S_AXIS_tvalid),             // end-of-packet
    .probe6(S_AXIS_tlast),
    .probe7(S_AXIS_tready),
    .probe8(gpio1_out_32_gp1[0])
);
*/
